...
namespace GraphicalConstraintProgramming.Constraints
{
    ...
    class ForbiddenPatternNonCyclicConstraint : SimpleConstraint
    {
        ...
        public ForbiddenPatternNonCyclicConstraint(String forbiddenPatterns)
        {
            this.forbiddenPatterns = forbiddenPatterns;
            lastValue = forbiddenPatterns;
        }

        public ForbiddenPatternNonCyclicConstraint()
        {
            ...
            using (StringReader reader = new StringReader(forbiddenPatterns))
            {
                ...
                do
                {
                    ...
                    if (line != null && line.Trim().Length > 0)
                    {
                        ...
                        if (pattern.Length > 0)
                        {
                            for (int i = 0; i < sortedVars.Count-pattern.Length+1; i++)
                            {
